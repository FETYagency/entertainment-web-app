...
export default function Header() {
  return (
    <header className="start-[32px] z-50 m-auto flex h-[56px] items-center justify-between bg-[#161D2F] px-[16px] py-[32px] md:max-w-[719px] md:rounded-[10px] xl:fixed xl:inset-y-[32px] xl:m-0 xl:h-auto xl:w-[96px] xl:flex-col xl:justify-start xl:gap-[75px]">
      <NavLink to={"/"} className="h-[20px] w-[25px] xl:h-auto xl:w-[32px]">
        <img src={logo} />
      </NavLink>
