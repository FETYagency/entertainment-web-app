...
export default function Posts({ content, h }) {
  ...
  if (!content) return <h1 className="text-white">Loadint...</h1>;
  return (
    <section>
      ...
      <div className=" grid grid-cols-2 gap-[16px] text-white  md:grid-cols-3 md:gap-[24px_30px] xl:grid-cols-4 xl:max-w-[1240px]">
        {content.map((per) => {
